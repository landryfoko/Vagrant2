    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                from("dropbox://get?"+getAuthParams()+"&remotePath=/CV.pdf")
//                        .to("file:///home/hifly/Desktop?fileName=pp.pdf")
                        .to("file://C:/Users/hp/Desktop/Pascal/pdf?fileName=pp.pdf")
//                        file:data/142/BookingResult?fileName=BookingResult_${date:now:yyyy-MM-dd hh-mm-ss}.xml
                        .to("mock:result");
            }
        };
    }
