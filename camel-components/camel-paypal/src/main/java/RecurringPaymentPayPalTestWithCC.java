...
public class RecurringPaymentPayPalTestWithCC {
	...
	public static void main(String[] args) throws Exception {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"C:\\Development\\Workspaces\\Git\\Libertas\\components\\camel-paypal\\src\\test\\resources\\paypal\\recurring-payment-camel-paypal-context.xml");
		CamelContext camelContext = (CamelContext) context.getBean("camelContext");
		ProducerTemplate producer;
		camelContext.start();
		producer = camelContext.createProducerTemplate();
		Exchange exchange = new DefaultExchange(camelContext);
		exchange.getOut().setHeader("CamelPayPalOperation", "RECURRING_PAYMENT_CREDITCARD");
		exchange.getOut().setHeader("CamelPayPalBillingStartDate", "2015-05-25T00:00:00:000Z");
